...
import os
myCmd = 'dmidecode -t 17'
# info = os.system(myCmd)
myCmd = os.popen(myCmd).read()
# print(myCmd)
print('myCmd\n', myCmd)
import subprocess
# subprocess.Popen('hal-find-by-capability --udi /org/freedesktop/Hal/devices/computer --key system.hardware.uuid'.split())
